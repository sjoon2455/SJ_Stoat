...
.method public declared-synchronized parse([Ljava/lang/String;)Lcom/vladium/util/args/IOptsParser$IOpts;
    ...
    :cond_0
    :try_start_1
    new-instance v8, Lcom/vladium/util/args/OptsParser$Opts;

    invoke-direct {v8}, Lcom/vladium/util/args/OptsParser$Opts;-><init>()V
    ...
    .line 147
    :pswitch_0
    invoke-static {v5, v3, v6}, Lcom/vladium/util/args/OptsParser;->isOpt(Ljava/lang/String;ILcom/vladium/util/args/OptsParser$OptDef;)Z
    ...
    .line 154
    invoke-static {v5, v9}, Lcom/vladium/util/args/OptsParser;->getOptNameAndValue(Ljava/lang/String;[Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v3, v10}, Lcom/vladium/util/args/OptsParser$OptDefMetadata;->getOptDef(Ljava/lang/String;[Ljava/lang/String;)Lcom/vladium/util/args/OptsParser$OptDef;
    ...
    invoke-virtual {v8, v3}, Lcom/vladium/util/args/OptsParser$Opts;->addError(Ljava/lang/String;)V
    ...
    .line 174
    :cond_2
    invoke-static {v3, v6}, Lcom/vladium/util/args/OptsParser;->getOptCanonicalName(Ljava/lang/String;Lcom/vladium/util/args/OptsParser$OptDef;)Ljava/lang/String;
    ...
    .line 177
    invoke-virtual {v8, v1}, Lcom/vladium/util/args/OptsParser$Opts;->getOpt(Ljava/lang/String;)Lcom/vladium/util/args/OptsParser$Opt;

    move-result-object v2

    .line 179
    invoke-virtual {v6}, Lcom/vladium/util/args/OptsParser$OptDef;->isMergeable()Z
    ...
    invoke-direct {v2, v3, v1, v5}, Lcom/vladium/util/args/OptsParser$Opt;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 184
    invoke-virtual {v8, v2, v6, v3}, Lcom/vladium/util/args/OptsParser$Opts;->addOpt(Lcom/vladium/util/args/OptsParser$Opt;Lcom/vladium/util/args/OptsParser$OptDef;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v1}, Lcom/vladium/util/args/OptsParser$Opts;->addError(Ljava/lang/String;)V
    ...
    .line 230
    invoke-virtual {v6}, Lcom/vladium/util/args/OptsParser$OptDef;->getValueCardinality()[I
    ...
    const-string v5, "\' does not accept values: \'"
    ...
    .line 250
    invoke-static {v1, v3, v6}, Lcom/vladium/util/args/OptsParser;->isOpt(Ljava/lang/String;ILcom/vladium/util/args/OptsParser$OptDef;)Z
    ...
    invoke-static {v4, v3, v6}, Lcom/vladium/util/args/OptsParser;->isOpt(Ljava/lang/String;ILcom/vladium/util/args/OptsParser$OptDef;)Z
    ...
    .line 297
    :cond_d
    invoke-virtual {v8, p1, v0}, Lcom/vladium/util/args/OptsParser$Opts;->setFreeArgs([Ljava/lang/String;I)V
    ...
    invoke-virtual {v8, v0}, Lcom/vladium/util/args/OptsParser$Opts;->addError(Ljava/lang/String;)V

    .line 332
    :cond_f
    :goto_6
    invoke-virtual {v8}, Lcom/vladium/util/args/OptsParser$Opts;->getOpts()[Lcom/vladium/util/args/IOptsParser$IOpt;
    ...
    invoke-virtual {v8, v6}, Lcom/vladium/util/args/OptsParser$Opts;->getOpt(Ljava/lang/String;)Lcom/vladium/util/args/OptsParser$Opt;
    ...
    const-string v7, "\' requires option \'"
    ...
    invoke-direct {p0, v6}, Lcom/vladium/util/args/OptsParser;->formatMessage(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v8, v6}, Lcom/vladium/util/args/OptsParser$Opts;->addError(Ljava/lang/String;)V
    ...
    invoke-virtual {v6}, Lcom/vladium/util/args/OptsParser$Opt;->getName()Ljava/lang/String;
    ...
    :goto_c
    invoke-virtual {v8, v1}, Lcom/vladium/util/args/OptsParser$Opts;->setUsageRequested(I)V
    :try_end_1
