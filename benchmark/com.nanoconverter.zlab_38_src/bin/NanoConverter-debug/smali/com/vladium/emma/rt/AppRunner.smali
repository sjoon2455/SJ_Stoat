...
.method protected _run(Lcom/vladium/util/IProperties;)V
    ...
    .line 588
    :goto_c
    invoke-virtual {v1}, Lcom/vladium/emma/rt/AppRunner$AppRunnerExitHook;->run()V

    .line 592
    if-eqz v11, :cond_a

    .line 594
    invoke-virtual {v11, v1}, Lcom/vladium/util/exit/ExitHookManager;->removeExitHook(Ljava/lang/Runnable;)Z

    .line 601
    :cond_a
    invoke-virtual {v1}, Lcom/vladium/emma/rt/AppRunner$AppRunnerExitHook;->getDataDumpFailure()Ljava/lang/Throwable;

    move-result-object v4

    .line 602
    invoke-virtual {v1}, Lcom/vladium/emma/rt/AppRunner$AppRunnerExitHook;->getReportFailures()Ljava/util/List;
    ...
    const-string v5, "exception while persisting raw session data:"

    invoke-virtual {v2, v3, v5, v4}, Lcom/vladium/logging/Logger;->log(ILjava/lang/String;Ljava/lang/Throwable;)V
